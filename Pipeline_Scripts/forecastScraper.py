#This python file pulls weather forecast data for Chicago from NOAA. Currently has temperature, humidity, wind speed, and hourly precipitation.
#NOAA website sometimes has a slow connection. Rerun the script after a few seconds if that is an issue.
