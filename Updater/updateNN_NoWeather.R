    ...
    print("Saving model.....")
    saveRDS(ir.nn, file = paste('data/Weather-and-Crime/Updater/temp_model_storage','/',crimeType, "/._NNmodel_NoWeather_", crimeType, "_", indexOfBaggedSamples, "_Update_", dateTime, ".rds", sep = ""))
