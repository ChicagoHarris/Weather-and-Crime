...
#Set this as input file name and path rather than use globals
		baggedFile=lagged_forecasts.csv
#Set this as output file name and path again rather than use globals
		binnedFile=binned_forecasts.csv
#Can keep this line as is		
