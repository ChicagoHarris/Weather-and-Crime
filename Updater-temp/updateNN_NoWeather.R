    ...
    trainedNN = readRDS(file = paste(modelDir, "/._NNmodel_NOWEATHER_", indexOfBaggedSamples, ".rds", sep = "")) 
    ...
    print("Saving model.....")
    saveRDS(ir.nn, file = paste(modelDir, "/._NNmodel_NoWeather_", crimeType, "_", indexOfBaggedSamples, "_Update_", dateTime, ".rds", sep = ""))
