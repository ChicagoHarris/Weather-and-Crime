...
Rscript ../src/preprocessData.R "robbery_count" 30 5 $DATAPATH/WeatherCrimeJan2015.csv $DATAPATH $DATAPATH
...
parallel Rscript ../src/trainNN.R "robbery_count" $DATAPATH $DATAPATH {1} 10 200 ::: {1..5}
